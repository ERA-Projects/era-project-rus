...
- Исправлено сообщение о бонусе набора "Scouting" перед боем.
...
- обновление ядра ERA.dll до версии 3.9.12:
 ...
 !!IP:M0/^array_var_name_1^/^array_var_name_2^/...;
  ...
  - В era.dll добавлены следующие экспортированные функции:
	...
	функция AllocErmFunc (FuncName: pchar; {i} out FuncId: целое число): TDwordBool; стандартный вызов;
...
- Ночная Разведка: Исправлено, что Ассассины не появляются.
