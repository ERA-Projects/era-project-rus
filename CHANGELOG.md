...
#### ERA ERM Framework:
- добавлен константа с адресом стандартного текстового буфера игры;
- добавлен константа с размером структуры BattleStack;
...
- обновлен плагин "GameplayEnhancementsPlugin.era":
	...
	- Исправлено закрытие любого всплывающего диалога, если у уже был другой диалог, вызванный ранее;
