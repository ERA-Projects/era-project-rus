...
#### WoG:
- обновлен плагин "game bug fixes extended.era":
...
- Dragon Town: Исправлена возможность перестроить Утопию, когда она находится на краю карты, что впоследствии приводило к проблемам.

#### Game Enhancement Mod:
- Заменить способность накопления опыта заклинания Death Ripple (Liches/Power Liches/Nightmare) на Advanced Sorrow.
- Удалены плагины:
...
- обновлен плагин "GameplayEnhancementsPlugin.era":
	...
	- Добавлена возможность устанавливать пользовательский вид карты приключений для героев:
		- Установить пользовательский вид для класса героя-мужчины:
		```
		"gem_plugin.map_item_view.54.class.[class_id].0": string
		```
		- Установить пользовательский вид для класса героя-женщины:
		```
		...
		```
	- Добавлена возможность устанавливать пользовательский вид карты приключений для разных уровней городов:
